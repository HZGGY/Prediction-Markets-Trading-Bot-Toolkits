...
impl fmt::Display for LedgerErrorCode {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        formatter.write_str(match self {
            ...
            Self::SnapshotWriteFailed => "snapshot_write_failed",
            Self::SnapshotFlushFailed => "snapshot_flush_failed",
            Self::SnapshotSyncFailed => "snapshot_sync_failed",
            Self::SnapshotPersistFailed => "snapshot_persist_failed",
            Self::SnapshotDirectorySyncFailed => "snapshot_directory_sync_failed",
            Self::Fatal => "fatal",
